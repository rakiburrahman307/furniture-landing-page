const HeaderTextOverlay = () => {
  return (
    <section className='max-w-[1220px] mx-auto h-[621.19px] mr-16 mt-52'>
      <div className='flex flex-col items-start justify-start relative h-full'>
        ...
        <div className='relative'>
          <p className='rotate-90 text-white text-[30px] md:text-[55px] font-mochiy absolute left-72 md:top-0 md:left-[800px]'>
            2024
          </p>
          <p className='absolute font-mochiy text-[#FFC39A] z-30 left-10 top-[380px] text-[70px] md:text-[192.13px] md:left-12 md:-top-28'>
            New
          </p>
          <div className='flex gap-2 absolute top-[280px] left-[120px] md:top-52 md:left-[254px]'>
          ...
          <p className='text-[#FF6F00] text-[60px] font-mochiy -z-10 absolute left-[50px] top-[480px] md:top-36 md:text-[131.59px] md:left-[480px]'>
            arrivals
          </p>
        </div>
        {/* Border and Text Container for Right Bottom */}
        <div className='absolute -right-16 md:right-0 bottom-20 md:bottom-32 flex flex-col items-center gap-10 md:gap-10'>
          <div className='border-l border-black h-[1.3cm] sm:h-[1cm] md:h-[0.8cm] lg:h-[1.3cm]'></div>
          <p className='rotate-90 text-sm font-mochiy text-[#313333] sm:text-xs md:text-[10px] lg:text-sm'>
            2024
          </p>
